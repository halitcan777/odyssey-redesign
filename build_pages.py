# -*- coding: utf-8 -*-
"""⛔ ЗАМОРОЖЕН с 26.07: страницы правятся РУКАМИ в HTML (решение команды).
Запуск build_pages.py ПЕРЕЗАПИШЕТ ручные правки всех внутренних страниц. Не запускать.
Оставлен как референс каркаса."""
import json, os
